...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MappingsSepc) DeepCopyInto(out *MappingsSepc) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MappingsSepc.
func (in *MappingsSepc) DeepCopy() *MappingsSepc {
	if in == nil {
		return nil
	}
	out := new(MappingsSepc)
	in.DeepCopyInto(out)
	return out
}
